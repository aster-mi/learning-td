...
export const questions: Question[] = [
  ...
  // ════════ 社会 / 地理 ════════
  { id: "c001", main: "社会", sub: "地理", level: 2, question: "にほんのしゅとは？",              choices: ["おおさか","とうきょう","きょうと","なごや"], answer: "とうきょう" },
  ...
  { id: "s029", main: "理科", sub: "物理・化学", level: 1, question: "たいようはどのほうこうからのぼる？",       choices: ["にし","みなみ","きた","ひがし"],                 answer: "ひがし" },
  { id: "s030", main: "理科", sub: "物理・化学", level: 1, question: "みずはなん℃でこおりになる？",           choices: ["-10℃","0℃","10℃","100℃"],                   answer: "0℃" },

  // ════════ 理科 / 物理・化学（小2 Lv.2 追加 s031〜s035）════════
  { id: "s031", main: "理科", sub: "物理・化学", level: 2, question: "Nきょくと Nきょくをちかづけると？",       choices: ["ひきあう","くっつく","へんかなし","しりぞけあう"],           answer: "しりぞけあう" },
  { id: "s032", main: "理科", sub: "物理・化学", level: 2, question: "でんちにまめでんきゅうをつなぐとなにがながれる？", choices: ["ねつ","ひかり","でんりゅう","みず"],                   answer: "でんりゅう" },
  { id: "s033", main: "理科", sub: "物理・化学", level: 2, question: "みずが100℃でふっとうするとなになる？",   choices: ["こおり","すいそ","さとう","すいじょうき"],                   answer: "すいじょうき" },
  { id: "s034", main: "理科", sub: "物理・化学", level: 2, question: "さとうとしょくえんはどちらもみずにとける？", choices: ["しょくえんのみ","さとうのみ","どちらもとけない","どちらもとける"], answer: "どちらもとける" },
  { id: "s035", main: "理科", sub: "物理・化学", level: 2, question: "でんち2こをちょくれつにつなぐとまめでんきゅうは？", choices: ["きえる","くらくなる","かわらない","あかるくなる"],     answer: "あかるくなる" },
  ...
  { id: "s128", main: "理科", sub: "生物・地学", level: 1, question: "チョウはどこからうまれる？",     choices: ["つちのなか","はなのなか","たまご","きのみ"],     answer: "たまご" },
  { id: "s129", main: "理科", sub: "生物・地学", level: 1, question: "サクラのはなはなにいろ？",       choices: ["あお","き","あか","ピンク・しろ"],               answer: "ピンク・しろ" },
  { id: "s130", main: "理科", sub: "生物・地学", level: 1, question: "はるにさくはなは？",         choices: ["ひまわり","コスモス","あさがお","さくら"],       answer: "さくら" },
  { id: "s131", main: "理科", sub: "生物・地学", level: 1, question: "しょくぶつがそだつのにひつようなものは？",   choices: ["おんがく","さとう","でんき","ひかりとみず"],     answer: "ひかりとみず" },
  { id: "s132", main: "理科", sub: "生物・地学", level: 1, question: "さかなはなんでこきゅうする？",             choices: ["はい","はな","ひふ","えら"],                     answer: "えら" },
  ...
  { id: "s136", main: "理科", sub: "生物・地学", level: 2, question: "なつとふゆでひるまがながいのはどちら？", choices: ["ふゆ","おなじ","はる","なつ"],                               answer: "なつ" },
  { id: "s137", main: "理科", sub: "生物・地学", level: 2, question: "たねがはつがするのにひつようなものは？",         choices: ["ひりょうとひかり","さとうとひかり","おととみず","みず・てきおん・くうき"], answer: "みず・てきおん・くうき" },
  ...
  { id: "c027", main: "社会", sub: "地理", level: 1, question: "にほんでいちばんきたにあるとどうふけんは？",         choices: ["あおもりけん","いわてけん","あきたけん","ほっかいどう"], answer: "ほっかいどう" },
  { id: "c028", main: "社会", sub: "地理", level: 1, question: "にほんでいちばんみなみにあるとどうふけんは？",         choices: ["かごしまけん","みやざきけん","ながさきけん","おきなわけん"], answer: "おきなわけん" },
  { id: "c029", main: "社会", sub: "地理", level: 1, question: "にほんのこっきにえがかれているものは？",       choices: ["ほし","ふじさん","さくら","あかいまる（おひさま）"],           answer: "あかいまる（おひさま）" },
  { id: "c030", main: "社会", sub: "地理", level: 1, question: "まるいちきゅうのかたちをしたちずをなんという？",     choices: ["えちず","せかいちず","だんめんず","ちきゅうぎ"], answer: "ちきゅうぎ" },

  // ════════ 社会 / 地理（小2 Lv.2 追加 c031〜c035）════════
  { id: "c031", main: "社会", sub: "地理", level: 2, question: "にほんでいちばんひとがおおいまちは？",     choices: ["おおさかし","なごやし","よこはまし","とうきょう"], answer: "とうきょう" },
  { id: "c032", main: "社会", sub: "地理", level: 2, question: "ふじさんはなんけんにある？",           choices: ["ながのけん","かながわけん","ぎふけん","やまなし・しずおかけん"], answer: "やまなし・しずおかけん" },
  ...
  { id: "e028", main: "英語", sub: "英単語", level: 1, question: '"red" のにほんごは？',    choices: ["あお","しろ","くろ","あか"],         answer: "あか" },
  { id: "e029", main: "英語", sub: "英単語", level: 1, question: '"blue" のにほんごは？',   choices: ["あか","しろ","みどり","あお"],       answer: "あお" },
  ...
  { id: "e034", main: "英語", sub: "英単語", level: 1, question: '"big" のにほんごは？',    choices: ["ちいさい","おなじ","かるい","おおきい"], answer: "おおきい" },
  { id: "e035", main: "英語", sub: "英単語", level: 1, question: '"small" のにほんごは？',  choices: ["おおきい","おもい","はやい","ちいさい"], answer: "ちいさい" },
  { id: "e036", main: "英語", sub: "英単語", level: 1, question: '"good" のにほんごは？',   choices: ["わるい","ふつう","つまらない","よい"], answer: "よい" },
  { id: "e037", main: "英語", sub: "英単語", level: 1, question: '"white" のにほんごは？',  choices: ["くろ","あか","あお","しろ"],         answer: "しろ" },
  { id: "e038", main: "英語", sub: "英単語", level: 1, question: '"black" のにほんごは？',  choices: ["しろ","はいいろ","あお","くろ"],     answer: "くろ" },
  { id: "e039", main: "英語", sub: "英単語", level: 1, question: '"sun" のにほんごは？',    choices: ["つき","ほし","くも","たいよう"],     answer: "たいよう" },
  { id: "e040", main: "英語", sub: "英単語", level: 1, question: '"new" のにほんごは？',    choices: ["ふるい","おおきい","はやい","あたらしい"], answer: "あたらしい" },

  // ════════ 英語 / 英単語（小2 Lv.2 追加 e041〜e050）════════
  { id: "e041", main: "英語", sub: "英単語", level: 2, question: '"book" のにほんごは？',    choices: ["ノート","えんぴつ","けしごむ","ほん"],  answer: "ほん" },
  { id: "e042", main: "英語", sub: "英単語", level: 2, question: '"friend" のにほんごは？',  choices: ["かぞく","せんせい","となり","ともだち"], answer: "ともだち" },
  { id: "e043", main: "英語", sub: "英単語", level: 2, question: '"happy" のにほんごは？',   choices: ["かなしい","おこっている","ねむい","うれしい"], answer: "うれしい" },
  { id: "e044", main: "英語", sub: "英単語", level: 2, question: '"run" のにほんごは？',     choices: ["あるく","およぐ","とぶ","はしる"],       answer: "はしる" },
  { id: "e045", main: "英語", sub: "英単語", level: 2, question: '"eat" のにほんごは？',     choices: ["のむ","あそぶ","かう","たべる"],         answer: "たべる" },
  { id: "e046", main: "英語", sub: "英単語", level: 2, question: '"play" のにほんごは？',    choices: ["べんきょうする","はたらく","やすむ","あそぶ"], answer: "あそぶ" },
  { id: "e047", main: "英語", sub: "英単語", level: 2, question: '"fast" のにほんごは？',    choices: ["おそい","おもい","かるい","はやい"],     answer: "はやい" },
  { id: "e048", main: "英語", sub: "英単語", level: 2, question: '"long" のにほんごは？',    choices: ["みじかい","かるい","うすい","ながい"],   answer: "ながい" },
  { id: "e049", main: "英語", sub: "英単語", level: 2, question: '"mother" のにほんごは？',  choices: ["おとうさん","おじいさん","いもうと","おかあさん"], answer: "おかあさん" },
  { id: "e050", main: "英語", sub: "英単語", level: 2, question: '"father" のにほんごは？',  choices: ["おかあさん","おばあさん","おにいさん","おとうさん"], answer: "おとうさん" },
];
